...
//        Read exits
        try (BufferedReader readFile = new BufferedReader(new FileReader("directions_big.txt"))){
            String input;
...
//                scanner.skip(scanner.delimiter());
//                String tempDest = scanner.nextLine();
//                int destination = Integer.parseInt(tempDest);
